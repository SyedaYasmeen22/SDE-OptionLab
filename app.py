...
st.caption(
    "A configurable simulation toolkit for pricing spread and better-of options on two correlated "
    "assets — multiple asset-dynamics models, multiple numerical engines, side-by-side diagnostics."
)
